...
const SectionNous = () => {
    ...
    return (
        <div className='container mx-auto w-3/4 mb-8'>
            <h1 className='text-3xl text-center mb-5 mt-7'>Ils parlent de nous</h1>
            <div className="carrousel-container rounded-lg shadow-lg ">
                <Slider {...settings}>
                    <div className="slide text-sm bg-[#dcfce7] text-center " >
                        <img src={profile} alt="" className='rounded-full mb-4 max-w-xs mx-auto p-3 '/>
                        <h3>Jean Dupont</h3>
                        <p>B2B solutions</p>
                        <p>Un grand merci à cette plateforme qui nous a permis de trouver des producteurs locaux de qualité. Les produits sont excellents et nos employés sont ravis.</p>
                    </div>
                    <div className="slide text-sm bg-[#000000] text-center text-white" >
                        <img src={profile} alt="" className='rounded-full mb-4 max-w-xs mx-auto p-3'/>
                        <p>Angele Martinez</p>
                        <p>B2B Solutions</p>
